                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <div class="devlog-entries">
                            <div class="entry">
                                <h2>Implementação do Sistema de Login</h2>
                                <p>correçao de links de paginas;<br>
                                    criaçao de telas devlog e contribuintes;<br>
                                </p>
                                <span class="date">Data: 26/09/2024</span>
                                <p class="card-text">
                                    <small class="text-body-secondary">3.0.1</small>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <div class="devlog-entries">
                            <div class="entry">
                                h2>Implementação do Sistema de Login</h2>
                                <p>telas mudadas para php;<br>
                                    Implementação da funçao de login e cadastro;<br>
                                    Criação de formulário de cadastro com validações;<br>
                                    Implementação da função de logout;<br>
                                    melhorias de tela sobre, index e Contate-nos
                                </p>
                                <span class="date">Data: 26/09/2024</span>
                                <p class="card-text">
                                    <small class="text-body-secondary">3.0.0</small>
                            </div>
                        </div>
                    </div>
                </div>
